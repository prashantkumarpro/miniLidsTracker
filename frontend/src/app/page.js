    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6 sm:space-y-8 relative">
      ...
      {isLeadsLoading && leads.length === 0 ? (
        <div className="relative select-none">
          ...
          <div className="hidden sm:block absolute -left-5 top-[40%] -translate-y-1/2 z-20 w-11 h-11 rounded-full bg-slate-900/40 border border-gray-800/30" />
          {/* Right Arrow Placeholder */}
          <div className="hidden sm:block absolute -right-5 top-[40%] -translate-y-1/2 z-20 w-11 h-11 rounded-full bg-slate-900/40 border border-gray-800/30" />
