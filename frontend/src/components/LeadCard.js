...
const LeadCard = ({ lead, onEdit, onDelete }) => {
  ...
  return (
    <div className="min-w-[280px] sm:min-w-0 flex-shrink-0 sm:flex-shrink bg-white/70 dark:bg-[#0c111e]/60 border border-gray-200/30 dark:border-gray-800/40 rounded-2xl p-5 lg:p-6 shadow-xs hover:border-gray-300 dark:hover:border-gray-700/60 hover:-translate-y-1 hover:shadow-md transition-all duration-300 flex flex-col justify-between h-full relative group overflow-hidden">
