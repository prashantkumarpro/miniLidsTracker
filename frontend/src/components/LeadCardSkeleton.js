...
const LeadCardSkeleton = () => {
  return (
    <div className="w-full bg-white/70 dark:bg-[#0c111e]/60 border border-gray-200/30 dark:border-gray-800/40 rounded-2xl p-5 lg:p-6 shadow-xs relative overflow-hidden animate-pulse flex flex-col justify-between min-h-[260px] select-none">
